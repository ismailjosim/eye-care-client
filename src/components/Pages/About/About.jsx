            ...
            <section className="bg-primary py-10 relative mb-5">
                <div className="container mx-auto">
                    <div className="block text-center">
                        ...
                        <h1 className="capitalize mb-5 text-4xl font-bold text-white">About Me & My Team</h1>
                    </div>
                </div>
            </section>
            ...
            <div className=" w-11/12 mx-auto py-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div>
                        ...
                        <p className="py-6 text-lg text-justify font-medium leading-8">Dr. Ford is a graduate of Forest Hills Central High School and a lifelong resident of the Grand Rapids area. He earned his bachelors and doctorate degrees from Ferris State University College of Optometry. His internships included the Optometric Institute and Clinic of Detroit, Duane L. Waters Hospital in Jackson, and the optometry clinic at Ferris State University.</p>
                        <p className="py-6 text-lg text-justify font-medium leading-8">Dr. Ford was honored as the Michigan Young Optometrist of the Year in 1995, and Optometrist of the Year in 2014, for his outstanding contributions to Optometry and the community. He is board certified by the American Board of Optometry. Dr. Ford is a primary care Optometrist with particular interest in specialty contact lens fittings and eye disease. He is currently active on the legislative committee of the Michigan Optometric Association and part-time Clinical Faculty at the Michigan College of Optometry. He is active in his church and enjoys golf and hockey. He and his wife, Carla, live in Grand Rapids and have 3 grown children.</p>
                    </div>
                    <div>
